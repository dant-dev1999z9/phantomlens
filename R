EADME.md# 🎮 phantomlens

![tool](https://img.shields.io/badge/tool-MIT-green?style=flat-square) ![Version](https://img.shields.io/badge/Version-1.2.0-blue?style=flat-square) ![Platform](https://img.shields.io/badge/Platform-Windows-lightgrey?style=flat-square) ![Python](https://img.shields.io/badge/Python-3.11%2B-3776AB?style=flat-square&logo=python&logoColor=white) ![Stars](https://img.shields.io/github/stars/dant-dev1999z9/phantomlens?style=flat-square) ![Last Commit](https://img.shields.io/github/last-commit/dant-dev1999z9/phantomlens?style=flat-square)

Apex merges capabilities from CommonMark, GFM, MultiMarkdown, Kramdown, and Marked into a single, potent Markdown processor
...
phantomlens is built for apex users who need a reliable, open-sou solution.

MIT tool. See [tool](tool) for details.

---

If you find **phantomlens** useful, give it a ⭐ — it helps others discover this project.
...
![phantomlens preview](assets/preview.svg)

![phantomlens config](assets/config-preview.svg)
...
```bash
git clone https://github.com/dant-dev1999z9/phantomlens.git
cd phantomlens
